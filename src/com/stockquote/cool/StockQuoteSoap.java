...
public interface StockQuoteSoap {
    ...
    @RequestWrapper(localName = "GetQuote", targetNamespace = "http://www.webserviceX.NET/", className = "com.stockquote.cool.GetQuote")
    @ResponseWrapper(localName = "GetQuoteResponse", targetNamespace = "http://www.webserviceX.NET/", className = "com.stockquote.cool.GetQuoteResponse")
